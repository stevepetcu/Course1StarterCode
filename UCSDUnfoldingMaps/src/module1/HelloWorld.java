...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map1 = new UnfoldingMap(this, 30, 50, 365, 500, provider);
		...
		// My map! :)
		map2 = new UnfoldingMap(this, 405, 50, 365, 500, provider);
		map2.zoomAndPanTo(zoomLevel, new Location(51.5287718, -0.2416787));
